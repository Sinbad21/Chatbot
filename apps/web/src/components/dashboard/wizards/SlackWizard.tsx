  ...
  <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
   <Card className="max-w-2xl w-full max-h-[90vh] overflow-y-auto bg-pearl-50 border border-silver-200/70">
    <div className="sticky top-0 bg-pearl-50/95 backdrop-blur border-b border-silver-200/70 p-6 flex items-center justify-between">
     <div>
      <h2 className="text-2xl font-bold text-charcoal">Integrazione Slack</h2>
      <p className="text-sm text-silver-700 mt-1">Salva token e signing secret</p>
     </div>
    ...
    <div className="p-6 space-y-4">
     <div>
      <label className="block text-sm font-medium text-silver-700 mb-2">Bot Token</label>
      <input
       type="password"
      ...
      />
      <p className="text-xs text-silver-600 mt-1">Slack App OAuth & Permissions Bot User OAuth Token</p>
     </div>

     <div>
      <label className="block text-sm font-medium text-silver-700 mb-2">Signing Secret</label>
      <input
       type="password"
       ...
       className="w-full px-4 py-3 bg-pearl-50 border border-silver-200/70 rounded-lg focus:ring-2 focus:ring-charcoal/10 focus:border-silver-300 text-charcoal placeholder:text-silver-500 transition-all"
      />
      <p className="text-xs text-silver-600 mt-1">Slack App Basic Information App Credentials</p>
     </div>
    </div>
