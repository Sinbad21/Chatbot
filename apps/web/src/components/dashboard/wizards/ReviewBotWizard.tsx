...
export function ReviewBotWizard({ onClose, onComplete, editMode, initialData }: ReviewBotWizardProps) {
  ...
  const [config, setConfig] = useState({
    ...
    completedMessage: initialData?.completedMessage || 'Grazie mille per il tuo tempo! ❤️',
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-2xl bg-gradient-to-br from-[#1a0b2e] to-[#0f0520] border border-purple-500/30 rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="sticky bottom-0 bg-[#1a0b2e]/95 backdrop-blur-md border-t border-purple-500/20 px-6 py-4 flex justify-between">
          ...
          <button
            onClick={nextStep}
            className="px-6 py-2 bg-gradient-to-r from-purple-600 to-fuchsia-600 text-white rounded-xl font-medium hover:from-purple-500 hover:to-fuchsia-500 transition-all shadow-lg shadow-purple-500/25 inline-flex items-center gap-2"
          >
      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            placeholder="🎉 Grazie per il tuo acquisto!"
            className="w-full px-4 py-3 bg-purple-900/30 border border-purple-500/30 rounded-xl text-white placeholder-purple-400/50 focus:outline-none focus:border-fuchsia-500/50"
          />
        ...
        <div>
          ...
          <input
            ...
            placeholder="Grazie mille per il tuo tempo! ❤️"
            className="w-full px-4 py-3 bg-purple-900/30 border border-purple-500/30 rounded-xl text-white placeholder-purple-400/50 focus:outline-none focus:border-fuchsia-500/50"
          />
        </div>
      </div>
