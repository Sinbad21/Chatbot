    ...
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
      <Card className="max-w-2xl w-full max-h-[90vh] overflow-y-auto bg-gradient-to-br from-[#2d1b4e] to-[#150a25] border border-purple-500/20">
        <div className="sticky top-0 bg-gradient-to-br from-[#2d1b4e] to-[#1a0f2e] border-b border-purple-500/20 p-6 flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-white">Integrazione HubSpot</h2>
            <p className="text-sm text-purple-300/70 mt-1">Salva il token della Private App</p>
          </div>
        ...
        <div className="p-6 space-y-4">
          <div>
            <label className="block text-sm font-medium text-purple-300/70 mb-2">Private App Token</label>
            <input
              type="password"
            ...
            />
            <p className="text-xs text-purple-400/50 mt-1">HubSpot  Settings  Integrations  Private Apps</p>
          </div>
        </div>
