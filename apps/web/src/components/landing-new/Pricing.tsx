      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-20">
          ...
          <div className="mt-8 flex justify-center">
            <Link
              href="/pricing"
              className="inline-block px-8 py-3 rounded-sm text-sm font-bold uppercase tracking-widest transition-all duration-300 border border-platinum-700 text-platinum-200 hover:border-platinum-400 hover:text-white hover:shadow-[0_0_20px_rgba(255,255,255,0.2)] hover:bg-platinum-900/40 active:scale-95"
            >
              Dettagli completi e add-on
            </Link>
          </div>
