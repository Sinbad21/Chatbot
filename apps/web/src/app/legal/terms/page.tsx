      ...
      <main className="pt-24 pb-20 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <article className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <p>
              By accessing or using Axiom Studio ("Service"), you agree to be bound by these
            ...
            <p>
              Axiom Studio provides AI-powered chatbot creation and deployment tools. The
            ...
            <p>
              ...
              are in USD and non-refundable except as required by law or as explicitly stated
              in our refund policy.
            </p>

            <h3>Free Trial</h3>
            <p>
              We may offer a free trial period. You will not be charged during the trial
              unless you explicitly choose to subscribe. Trials automatically convert to paid
              subscriptions unless cancelled.
            </p>

            <h3>Cancellation</h3>
            <p>
              You may cancel your subscription at any time from your account settings. You
            ...
            <p>
              ...
              Axiom Studio and protected by copyright and other intellectual property laws.
            </p>

            <h3>Your Content</h3>
            <p>
              You retain ownership of all content you upload to the Service. By uploading
              content, you grant us a license to use it to provide the Service.
            </p>

            <h2>7. Data and Privacy</h2>
            <p>
              Your use of the Service is subject to our Privacy Policy. We process your data
            ...
            <p>
              ...
              the Service. We reserve the right to suspend or discontinue the Service with
              reasonable notice.
            </p>
            ...
            <p>
              You agree to indemnify and hold harmless Axiom Studio from any claims,
            ...
            <p>
              ...
              material changes by email or through the Service. Continued use constitutes
