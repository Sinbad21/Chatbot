      ...
      <main className="pt-24 pb-20 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <article className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <h2>Our Story</h2>
            <p>
              Axiom Studio was founded in 2024 with a simple idea: customer support should be
            ...
            <p>
              ...
              businesses use Axiom Studio to provide better customer service, generate more
