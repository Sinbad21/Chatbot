            ...
            {recentBots.map((bot) => (
              <div key={bot.id} className="flex items-center justify-between border-b border-silver-200/70 pb-4 last:border-b-0">
                ...
                <button
                  ...
                  className="px-6 py-3 bg-gradient-to-r from-purple-600 to-fuchsia-600 text-charcoal rounded-lg hover:from-purple-500 hover:to-fuchsia-500 font-medium transition-all shadow-lg shadow-purple-500/25"
                >
                  {t('dashboard.view')}
                </button>
              </div>
