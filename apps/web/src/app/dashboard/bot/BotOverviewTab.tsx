    ...
    <div className="space-y-6">
      ...
      <div className="bg-black/40 backdrop-blur-md rounded-lg shadow p-6">
        ...
        <select
          ...
          className="w-full px-4 py-2 border border-white/20 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
        >
          {MODELS.map((m) => (
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={6}
              className="w-full px-4 py-2 border border-white/20 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent font-mono text-sm"
            />
            <p className="text-xs text-white/50 mt-1">
