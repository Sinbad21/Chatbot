        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex gap-3">
            <input
              ...
              className="flex-1 px-3 py-2 border border-white/20 rounded-lg text-sm text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-indigo-500"
