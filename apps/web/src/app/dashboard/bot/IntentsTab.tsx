  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-12">
        <div className="text-white/60">Loading intents...</div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-black/40 backdrop-blur-md rounded-lg shadow-sm border border-white/10 p-6">
        <h3 className="text-lg font-semibold text-white mb-4">Add New Intent</h3>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-white/20 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-white placeholder:text-white/40 bg-transparent"
              required
            />
          </div>

          <div>
            <label htmlFor="patterns" className="block text-sm font-medium text-white/70 mb-1">
            ...
            <textarea
              ...
              placeholder="hello&#10;hi&#10;hey there&#10;good morning"
              rows={5}
              className="w-full px-4 py-2 border border-white/20 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent resize-none font-mono text-sm text-white placeholder:text-white/40 bg-transparent"
              required
            />
          ...
          <div>
            <label htmlFor="response" className="block text-sm font-medium text-white/70 mb-1">
              Response
            </label>
            <textarea
              id="response"
              ...
              rows={4}
              className="w-full px-4 py-2 border border-white/20 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent resize-none text-white placeholder:text-white/40 bg-transparent"
              required
            />
          </div>
          ...
          <div className="space-y-4">
            {intents.map((intent) => (
              ...
              >
                ...
                <div className="mb-3">
                  <p className="text-xs font-medium text-white/70 mb-1">Patterns:</p>
                ...
                <div>
                  <p className="text-xs font-medium text-white/70 mb-1">Response:</p>
                  <p className="text-sm text-white/60">{intent.response}</p>
                </div>
              </div>
            ))}
          </div>
